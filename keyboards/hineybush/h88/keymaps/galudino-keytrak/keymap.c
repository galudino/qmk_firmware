...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [KM_MACOS] = LAYOUT_tkl_ansi_wkl_custom(
  ...
  [KM_FUNC] = LAYOUT_tkl_ansi_wkl_custom(
    KC_GRV,     KC_F14, KC_F15, KC_F16, KC_F17, KC_F18, KC_F19, KC_F20, KC_F21, KC_F22, KC_F23, KC_F24, XXXXXXX,                 XXXXXXX,             _______,  _______, _______,   \
    KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,                      _______, KC_DEL,             KC_INS,   _______, _______,   \
    ...
    KC_CAPS, _______, _______,                            MO(KM_SETTINGS),                      KC_RALT, _______, _______,         _______,  _______, _______    \
    ),
