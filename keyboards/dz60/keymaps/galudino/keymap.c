...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [KM_MACOS] = LAYOUT(
        ...
        KC_LCTL, 	KC_LGUI, KC_LALT, XXXXXXX, KC_SPC, XXXXXXX, XXXXXXX, KC_RALT, XXXXXXX,  KC_RGUI, KC_RCTL),
    ...
    [KM_FUNC] = LAYOUT(
        ...
        KC_CAPS, 	KC_TRNS, KC_APFN, XXXXXXX, MO(KM_SETTINGS), XXXXXXX, XXXXXXX, KC_TRNS, XXXXXXX,  KC_APP,  KC_TRNS),
