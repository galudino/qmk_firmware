...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [KM_MACOS] = LAYOUT_all(
        ...
        KC_LCTL, 	KC_LALT, XXXXXXX,  KC_LGUI, XXXXXXX,  KC_SPC, XXXXXXX, 			    XXXXXXX, KC_RGUI, KC_RALT,   KC_APP,  KC_RCTL),
    ...
    [KM_FUNC] = LAYOUT_all(
        ...
        KC_CAPS, 	KC_TRNS, XXXXXXX,  KC_APFN, XXXXXXX,  MO(KM_SETTINGS), XXXXXXX, 			    XXXXXXX, KC_TRNS, XXXXXXX,   KC_RALT,  KC_TRNS),
