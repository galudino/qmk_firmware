...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [KM_MACOS] = LAYOUT_all(
        ...
        KC_LSFT, 	XXXXXXX,   KC_Z,   KC_X,    KC_C,    KC_V,   KC_B,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, XXXXXXX, KC_RSFT, LT(KM_FUNC, KC_ESC),
    ...
    [KM_FUNC] = LAYOUT_all(
        ...
        KC_TRNS, 	XXXXXXX,   KC_TRNS,   KC_TRNS,    KC_TRNS,    KC_TRNS,   KC_TRNS,   KC_DEL,    KC_END,    KC_PGDN, KC_TRNS,  KC_TRNS, XXXXXXX, KC_APFN, KC_TRNS,
